module k_regs (
  ...
  initial begin
    ...
    $readmemh("../mem_files/bottom_sobel.mem", filter0, 0, 8);
    $readmemh("../mem_files/emboss.mem", filter1, 0, 8);
    $readmemh("../mem_files/outline.mem", filter2, 0, 8);
    $readmemh("../mem_files/identify.mem", filter3, 0, 8);
